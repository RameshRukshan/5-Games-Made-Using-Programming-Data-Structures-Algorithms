 ...
 * @author rames
 */
public class InvalidAnswer extends javax.swing.JFrame {

    /**
     * Creates new form InvalidAnswer
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assests/invalid_answer.png"))); // NOI18N

        lbl_Invalid_txt.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        lbl_Invalid_txt.setForeground(new java.awt.Color(0, 0, 0));
        lbl_Invalid_txt.setText("Sorry! You Lose Try Again");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InvalidAnswer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InvalidAnswer().setVisible(true);
            }
        });
    }
