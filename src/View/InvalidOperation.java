 ...
 * @author rames
 */
public class InvalidOperation extends javax.swing.JFrame {

    /**
     * Creates new form InvalidOperation
     */
    public InvalidOperation(String text) {
        initComponents();
        lbl_Invalid_txt.setText(text);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assests/invalid-removebg-preview.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InvalidOperation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InvalidOperation("Invalid").setVisible(true);
            }
        });
    }
